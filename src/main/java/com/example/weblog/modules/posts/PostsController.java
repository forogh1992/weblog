...
import com.example.weblog.modules.category.CategoryService;
import com.example.weblog.modules.users.UsersService;
...
public class PostsController {
    ...
    public String register(@ModelAttribute(name = "post") @Valid Posts posts,
        ...
        posts.setUsers(usersService.findByEmail(principal.getName()));   // set user's name to post
